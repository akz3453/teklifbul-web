...
class MetricsStore {
    constructor() {
        ...
        this.MAX_SAMPLES_PER_ROUTE = 200;
        // Teklifbul Rule v1.0 - Windowed Metrics v2: Global event ring buffer
        this.events = [];
        this.MAX_EVENTS = Number(process.env.OBS_EVENTS_MAX) || 10000;
    }
    /**
