...
export function calculateCost(
  ...
  const inputCost = (promptTokens / 1_000_000) * costs.inputPricePerMillion;
  const outputCost = (completionTokens / 1_000_000) * costs.outputPricePerMillion;
 ...
 */
export function getCheaperProvider(
  promptTokens: number,
  completionTokens: number
): 'openai' | 'gemini' {
 ...
 */
export function getDefaultCheaperProvider(): 'openai' | 'gemini' {
