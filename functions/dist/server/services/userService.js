 ...
 */
export function userHasAiPlan(planIdOrCode) {
 ...
 */
export async function getUserAIProvider(userId) {
    try {
        ...
        const aiProvider = data.ai_provider || getSafeDefaultProvider();
