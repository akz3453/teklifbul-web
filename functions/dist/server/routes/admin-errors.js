...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        const { type, severity, resolved, search, limit = '50', offset = '0', orderBy = 'timestamp', orderDirection = 'desc' } = req.query;
        ...
        if (search) {
            ...
            errors = errors.filter(error => error.message?.toLowerCase().includes(searchLower) ||
