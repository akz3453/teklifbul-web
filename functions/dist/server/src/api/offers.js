...
import { OfferSchema } from '../../../src/domain/offer/schema.js';
import { importSupplierOffer } from '../../../src/import/excel/supplierOfferImport.js';
import { exportSupplierOffer } from '../../../src/export/excel/supplierOfferExport.js';
...
async function getActorCompany(req) {
    const user = req.user;
    if (!user?.uid)
        return null;
 ...
 * ```
 */
function validateBusinessRules(offer) {
    const issues = [];
    // Zorunlu alanlar
