 ...
 */
async function getGlobalAiControls() {
    try {
 ...
 * Teklifbul Rule v3.11 - Fail open: if read fails, return enabled=true
 */
async function getCompanyAiControls(companyId) {
    try {
        const db = await getAdminDb();
        if (!db) {
 ...
 */
export async function evaluateAiAvailability(companyId) {
 ...
 */
export function clearKillSwitchCache(companyId) {
    globalCache = null;
    if (companyId) {
