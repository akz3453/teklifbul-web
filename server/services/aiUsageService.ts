...
import { AiPlan } from './userService.js';
  ...
  try {
    ...
    await db.runTransaction(async (tx) => {
      ...
      if (snap.exists) {
        ...
        existingPromptTokens = (data.promptTokens as number) || 0;
        existingCompletionTokens = (data.completionTokens as number) || 0;
        existingTotalTokens = (data.totalTokens as number) || 0;
        existingCostUsd = (data.costUsd as number) || 0;
      }
