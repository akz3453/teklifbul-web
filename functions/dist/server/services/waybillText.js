...
async function getPdfParser() {
    ...
    try {
        ...
        logger.warn('PDF parse module load failed, trying cjs fallback', { error: err?.message });
    }
    try {
        ...
        logger.error('PDF parse require fallback failed', { error: err?.message });
    }
    return null;
}
...
export async function extractWaybillText(buffer, mimeType) {
