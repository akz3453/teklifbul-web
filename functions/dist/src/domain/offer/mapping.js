 ...
 */
export function mapDemandToOfferHeader(demand) {
    return {
 ...
 */
export function mapDemandItemsToOfferLines(demand) {
 ...
 */
export function extractFromDOM(selector) {
 ...
 */
export function extractDemandFromPage() {
    return {
        ...
        priority: extractFromDOM('#d-priority'),
        dueDate: extractFromDOM('#d-duedate'),
        currency: extractFromDOM('#d-currency'),
        biddingMode: extractFromDOM('[data-bidding-mode]'),
    };
}
export function calculateDifference(demandLine, offerLine) {
    const result = {
        hasDifference: false,
    };
    // Miktar farkı
