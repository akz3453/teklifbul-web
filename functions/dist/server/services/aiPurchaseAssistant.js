 ...
 */
export async function askTeklifbulAssistant(userMessage, context) {
 ...
 */
export async function fetchBidData(filters) {
    try {
 ...
 * Teklifbul Rule v1.0 - Firestore query limit zorunlu
 */
export async function fetchStockData(filters) {
    try {
 ...
 */
export async function aiPurchase(prompt, bids, stock) {
