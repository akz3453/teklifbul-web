...
import { parseTwoColumnProfile, parseTwoSheetProfile } from '../services/importABProfile';
      ...
      try {
        ...
        Object.entries(twoSheetResult.demand || {}).forEach(([key, value]) => {
          if (value && typeof value === 'object' && 'value' in value) {
            demandValues[key] = (value as any).value;
          } else if (value) {
        ...
        const demandMappings: any[] = [];
        const fieldCandidates: any[] = [];
      ...
      try {
        ...
        Object.entries(abResult.demand).forEach(([key, value]) => {
          ...
          if (typeof value === 'object' && value !== null && 'value' in (value as object)) {
            demandValues[key] = (value as { value: any }).value;
          } else {
        ...
        Object.keys(abResult.demand).forEach(key => {
          const value = abResult.demand[key as keyof typeof abResult.demand];
          if (value) {
            demandMeta[key] = {
              confidence: 1.0,
              needsReview: false,
