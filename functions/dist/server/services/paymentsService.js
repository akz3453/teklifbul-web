...
import { createInvoiceRecord, createPaymentIntentRecord, recordAuditEvent, upsertSubscription } from './subscriptionService.js';
const DEFAULT_CHECKOUT_BASE_URL = 'https://pay.teklifbul-sandbox.local/checkout';
function isSandboxCheckoutUrl(url) {
...
export function isMockPurchaseEnabled() {
 ...
 */
async function claimSucceededIntent(paymentIntentId, payload) {
...
export async function handlePaymentWebhook(rawBody, payload, signature) {
    ...
    if (payload.type === 'payment.succeeded') {
        ...
        const planId = (intent.planId || payload.data.planId);
