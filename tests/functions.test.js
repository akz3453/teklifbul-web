...
// IMPORTANT: Import pure helpers only (avoid Cloud Functions side effects in tests)
import { buildSearchTokens, normalizeTRForSearch, tokensChanged } from '../functions/src/lib/stockSearchTokens';
