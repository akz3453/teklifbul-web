 ...
 */
function generateAlertMessage(company: any): { message: string; suggestedActions: string[] } {
 ...
 */
router.get('/alerts/profit', async (req: AuthenticatedRequest, res) => {
  try {
    ...
    companyReports.sort((a, b) => {
      ...
      if (a.burnRatio === null && b.burnRatio === null) return 0;
      if (a.burnRatio === null) return 1;
      if (b.burnRatio === null) return -1;
      if (b.burnRatio !== a.burnRatio) return b.burnRatio - a.burnRatio;
      
      // 2) profitTRY asc (more negative first)
      if (a.profitTRY !== b.profitTRY) return a.profitTRY - b.profitTRY;
